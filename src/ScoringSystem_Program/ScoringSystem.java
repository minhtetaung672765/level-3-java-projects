        ...
        do{
            ...
            switch(option){
                ...
                case 2:
                    ...
                    // limitation for individuals - 20

                    while(PartNo == 0 || PartNo > 20){
                        System.out.println(" LIMITED SPACE FOR INDIVIDUALS IS 20. Please enter less than 20 (inclusive) : ");
                        PartNo = scan.nextInt();
                    }
                ...
                case 4:
                    ...
                    // space limitation for individuals - 20

                    while(SpecPartNo == 0 || SpecPartNo > 20){
                        System.out.println(" LIMITED SPACE FOR INDIVIDUALS IS 20. Please enter less than 20 (inclusive) : ");
                        SpecPartNo = scan.nextInt();
                    }
